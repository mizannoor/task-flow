...
export const en = {
  ...
  bulk: {
    ...
    selectedPlural: '{count} tasks selected',
    selectAll: 'Select all',
    clearSelection: 'Clear selection',
    selectionWarning: 'Large selection may take longer to process',
    maxSelectionReached: 'Maximum selection of {max} tasks reached',
    delete: {
      button: 'Delete',
      confirm: 'Delete {count} tasks?',
      confirmSingular: 'Delete {count} task?',
      warning: 'This action cannot be undone. All selected tasks will be permanently deleted.',
      success: '{count} tasks deleted',
      successSingular: '{count} task deleted',
      error: 'Failed to delete tasks',
    },
    status: {
      button: 'Change Status',
      success: '{count} tasks updated',
      successSingular: '{count} task updated',
      error: 'Failed to update tasks',
      blockedWarning: 'Some tasks are blocked by dependencies',
      blockedCount: '{count} tasks are blocked',
      skipBlocked: 'Skip blocked tasks',
    ...
    reassign: {
      ...
      successSingular: '{count} task reassigned to {userName}',
    ...
    tags: {
      ...
      noTagsToRemove: 'No common tags found in selected tasks',
      success: '{count} tasks updated',
      successSingular: '{count} task updated',
